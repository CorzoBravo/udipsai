...
interface ValoracionProfesionalFormProps {
  data: string;
  onChange: (value: string) => void;
  onValidate?: (isValid: boolean) => void;
}

const ValoracionProfesionalForm: React.FC<ValoracionProfesionalFormProps> = ({
  data,
  onChange,
  onValidate,
}) => {
    ...
    <div className="space-y-4">
      <div>
        ...
        <textarea
          ...
          placeholder="Incluya su análisis y valoración profesional del caso..."
...
export default ValoracionProfesionalForm;
