...
interface RecomendacionesFormProps {
  data: string;
  onChange: (value: string) => void;
  onValidate?: (isValid: boolean) => void;
}

const RecomendacionesForm: React.FC<RecomendacionesFormProps> = ({
  data,
  onChange,
  onValidate,
}) => {
    ...
    <div className="space-y-4">
      <div>
        ...
        <textarea
          ...
          placeholder="Proporcione recomendaciones específicas para el caso..."
