...
interface SituacionEntornoFormProps {
  data: string;
  onChange: (value: string) => void;
  onValidate?: (isValid: boolean) => void;
}

const SituacionEntornoForm: React.FC<SituacionEntornoFormProps> = ({
  data,
  onChange,
  onValidate,
}) => {
    ...
    <div className="space-y-4">
      <div>
        ...
        <textarea
          ...
          placeholder="Describa el entorno social del paciente..."
...
export default SituacionEntornoForm;
