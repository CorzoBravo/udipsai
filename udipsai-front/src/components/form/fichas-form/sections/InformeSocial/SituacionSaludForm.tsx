...
interface SituacionSaludFormProps {
  data: string;
  onChange: (value: string) => void;
  onValidate?: (isValid: boolean) => void;
}

const SituacionSaludForm: React.FC<SituacionSaludFormProps> = ({
  data,
  onChange,
  onValidate,
}) => {
    ...
    <div className="space-y-4">
      <div>
        ...
        <textarea
          ...
          placeholder="Describa el estado de salud del paciente y su familia..."
...
export default SituacionSaludForm;
