...
const SituacionEconomicaInformeForm: React.FC<SituacionEconomicaFormProps> = ({
  data,
  onChange,
  onValidate,
}) => {
    ...
    <div className="space-y-4">
      <div>
        ...
        <textarea
          ...
          placeholder="Describa la situación económica del paciente y su familia..."
...
export default SituacionEconomicaInformeForm;
